...
function Footer() {
  ...
  const legalSection = (
    <div className="flex flex-col gap-6">
      ...
      <div className="bg-white/5 p-6 border border-white/10">
        <p className="text-[11px] text-gray-500 leading-relaxed uppercase tracking-widest font-bold mb-4">JM News</p>
  ...
  const bottomBar = (
    <div className="max-w-7xl mx-auto mt-16 pt-8 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-4 text-[10px] uppercase font-bold tracking-[0.2em] text-gray-600">
      <div>{copyright || '© 2026 Toko Technologies. All rights reserved.'}</div>
  ...
  if (footerStyle === 'minimal') {
    return (
      <footer className="pt-16 pb-8 px-6 text-center" style={footerBg}>
        <p className="text-[10px] uppercase font-bold tracking-widest" style={{ color: 'var(--color-text-muted, #6b7280)' }}>{copyright || '© 2026 Toko Technologies. All rights reserved.'}</p>
      </footer>
    );
  }
